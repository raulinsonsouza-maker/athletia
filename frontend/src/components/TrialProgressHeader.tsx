...
export default function TrialProgressHeader() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-primary/30 via-primary/20 to-primary/30 border-b border-primary/40 backdrop-blur-xl">
