interface IconeConquistaProps {
  tipo: string
  className?: string
}

export default function IconeConquista({ tipo, className = 'w-8 h-8' }: IconeConquistaProps) {
  const iconClasses = `${className} text-primary`
