        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-light-muted leading-relaxed">
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">1. Introdução</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">2. Informações que Coletamos</h2>
              <p>Coletamos os seguintes tipos de informações:</p>
              
              <h3 className="text-xl font-semibold text-light mt-4">2.1. Informações Fornecidas por Você</h3>
              ...
              <h3 className="text-xl font-semibold text-light mt-4">2.2. Informações Coletadas Automaticamente</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">3. Como Usamos suas Informações</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">4. Compartilhamento de Informações</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">5. Segurança dos Dados</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">6. Retenção de Dados</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">7. Seus Direitos</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">8. Cookies e Tecnologias Similares</h2>
              <p>
                Utilizamos cookies e tecnologias similares para melhorar sua experiência, analisar o uso do serviço e personalizar 
                conteúdo. Para mais informações, consulte nossa <Link to="/cookies" className="text-primary hover:underline">Política de Cookies</Link>.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">9. Privacidade de Menores</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">10. Transferência Internacional de Dados</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-light">11. Alterações nesta Política</h2>
              <p>
